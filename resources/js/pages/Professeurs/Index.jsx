...
const Index = ({ professeurs, filters }) => {
    ...
    const handleSearch = debounce((value) => {
        router.get('/professeurs', { search: value, perPage }, {
            preserveState: true,
            replace: true
        });
    }, 300);
    ...
    const handlePerPageChange = (value) => {
        setPerPage(value);
        router.get('/professeurs', { search, perPage: value }, {
            preserveState: true,
            replace: true
        });
    };

    const handleDelete = (professeur) => {
            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="text-indigo-100 mt-2 text-lg">
                                Gérez le corps professoral de l'établissement
                            </p>
                        </div>
                        <div className="mt-4 lg:mt-0">
                            <Link
                                href="/professeurs/create"
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:space-x-6 space-y-4 lg:space-y-0">
                        <div className="flex-1">
                            <div className="relative">
                                ...
                                <input
                                    type="text"
                                    placeholder="Rechercher un professeur par nom, prénom, spécialité..."
                                    defaultValue={search}
                                    onChange={(e) => {
                        ...
                        <div className="lg:w-48">
                            <select
                                ...
                                className="block w-full pl-4 pr-10 py-3.5 border-2 border-gray-200 rounded-xl bg-white focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200"
                            >
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                    ...
                    <div className="hidden lg:grid grid-cols-12 bg-gradient-to-r from-gray-50 to-indigo-50 px-6 py-4 text-sm font-semibold text-gray-700 uppercase tracking-wider border-b border-gray-200">
                        ...
                        <div className="col-span-3">Spécialité</div>
                        <div className="col-span-2 text-right">Actions</div>
                    </div>

                    <div className="divide-y divide-gray-200">
                        {professeurs.data.map((professeur) => (
                            <div key={professeur.id} className="hover:bg-gray-50/50 transition-all duration-200">
                                        ...
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="text-sm text-gray-600">{professeur.email}</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="hidden lg:grid grid-cols-12 gap-6 items-center">
                                        ...
                                        <div className="col-span-3">
                                            <div className="space-y-1">
                                                <div className="text-sm font-medium text-gray-900">{professeur.email}</div>
                                                {professeur.telephone && (
                    ...
                    {professeurs.data.length === 0 && (
                        <div className="text-center py-16">
                            ...
                            <h3 className="text-xl font-semibold text-gray-900 mb-2">Aucun professeur trouvé</h3>
                            <p className="text-gray-600 mb-6 max-w-md mx-auto">
                                {search ? 'Aucun professeur ne correspond à votre recherche.' : 'Commencez par créer votre premier professeur.'}
                            </p>
                            <Link
                                href="/professeurs/create"
                ...
                {professeurs.data.length > 0 && (
                    <div className="mt-8 flex flex-col sm:flex-row items-center justify-between space-y-4 sm:space-y-0">
                        <div className="text-sm text-gray-700">
                            Affichage de <span className="font-semibold">{professeurs.from}</span> à <span className="font-semibold">{professeurs.to}</span> sur <span className="font-semibold">{professeurs.total}</span> résultats
                        </div>
