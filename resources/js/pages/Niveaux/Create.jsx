                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-purple-100 mt-2 text-lg">
                                Ajoutez un nouveau niveau pédagogique
                            </p>
                        </div>
                        ...
                        <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-2xl p-6 border border-purple-200">
                            ...
                            <div className="space-y-3">
                                <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-purple-100">
                                    <div>
                                        <div className="font-medium text-purple-900">{data.nom || 'Nom du niveau'}</div>
                                        <div className="text-sm text-purple-600">
                                            {data.cycle_id ? 
                                                cycles.find(c => c.id == data.cycle_id)?.nom 
                                                : 'Cycle non sélectionné'
                                            }
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-xs text-purple-500">Moyenne min</div>
                                        <div className={`text-lg font-bold ${getMoyenneColor(data.moyenne_min_pour_passage)} px-2 py-1 rounded-full`}>
                                            {data.moyenne_min_pour_passage}/20
                                        </div>
                                    </div>
                                </div>
                                <div className="text-sm text-purple-700">
                                    💡 Vous pourrez ajouter des classes et matières après la création du niveau
                                </div>
                            </div>
                        </div>
                    )}
                        ...
                        >
                            {processing ? (
                                ...
                                <>
                                    ...
                                    <span className="font-semibold">Créer le niveau</span>
                                </>
                            )}
                        </button>
                    </div>
