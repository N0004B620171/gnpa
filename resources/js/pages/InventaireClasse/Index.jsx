...
const Index = ({ inventaires, filters }) => {
    ...
    const handleSearch = debounce((value) => {
        router.get('/inventaires-classes', { search: value }, {
            preserveState: true,
            replace: true
        });
    }, 300);
    ...
    const handleDelete = (inventaire) => {
        if (confirm(`Êtes-vous sûr de vouloir supprimer l'inventaire "${inventaire.materiel.nom}" de la classe ${inventaire.classe.nom} ?`)) {
    ...
    return (
        <AppLayout>
            <Head title="Inventaire des Classes" />
            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
                        <div>
                            ...
                            <p className="text-indigo-100 mt-2 text-lg">
                                Gérez le matériel attribué aux classes
                            </p>
                        </div>
                        <Link
                            href="/inventaires-classes/create"
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                        ...
                        <div className="lg:col-span-3">
                            <div className="relative group">
                                ...
                                <input
                                    type="text"
                                    placeholder="Rechercher par matériel, classe, état..."
                                    value={search}
                                    onChange={(e) => {
                                        setSearch(e.target.value);
                                        handleSearch(e.target.value);
                                    }}
                                    className="block w-full pl-12 pr-12 py-3 border-2 border-gray-200 rounded-xl bg-white placeholder-gray-500 focus:outline-none focus:ring-4 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all duration-200 hover:border-gray-300"
                                />
                        ...
                        {/* Compteur d'éléments d'inventaire */}
                        <div className="flex items-center justify-end lg:justify-start">
                            <span className="text-sm font-medium text-indigo-700 bg-indigo-50 border border-indigo-200 px-4 py-3 rounded-xl flex items-center gap-2">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div className="mt-4 bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-xl p-4">
                            <div className="flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="text-indigo-600 hover:text-indigo-800 font-medium flex items-center gap-1 text-sm transition-colors"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M6 18L18 6M6 6l12 12" />
                                    </svg>
                ...
                <div className="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                    ...
                    <div className="hidden lg:grid grid-cols-12 bg-gradient-to-r from-gray-50 to-indigo-50 px-6 py-4 text-sm font-semibold text-gray-700 uppercase tracking-wider border-b border-gray-200">
                                    ...
                                    <div className="lg:hidden space-y-4">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center">
                                                <div className="flex-shrink-0 h-12 w-12 bg-gradient-to-r from-indigo-100 to-purple-100 rounded-xl flex items-center justify-center">
                                                ...
                                                <div className="ml-4">
                                                    ...
                                                    <p className="text-sm text-gray-600">{inventaire.classe.nom}</p>
                                                </div>
                                            </div>
                                            <div className={`px-3 py-1 rounded-full text-sm font-medium border-2 ${getEtatColor(inventaire.etat)}`}>
                                        ...
                                        <div className="space-y-2">
                                            ...
                                            <div className="flex items-center justify-between">
                                                <div className="text-sm text-gray-500">
                                                    Ajouté le {new Date(inventaire.date_ajout).toLocaleDateString('fr-FR')}
                                                </div>
                                    ...
                                    <div className="hidden lg:grid grid-cols-12 gap-6 items-center">
                                        ...
                                        <div className="col-span-2">
                                            <div className="text-lg font-medium text-gray-900">
                                                {inventaire.classe.nom}
                                            </div>
                                            <div className="text-sm text-gray-600">
                                                {inventaire.classe.niveau?.nom}
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-span-2">
                                            <div className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-bold border-2 ${getEtatColor(inventaire.etat)}`}>
                                                {getEtatLabel(inventaire.etat)}
                                            </div>
                                        </div>
                                        <div className="col-span-3">
                        ...
                        <div className="text-center py-16">
                            ...
                            <p className="text-gray-600 mb-6 max-w-md mx-auto">
                                {search
                                    ...
                                    : 'Commencez par attribuer du matériel aux classes.'}
                            </p>
                            <Link
                                href="/inventaires-classes/create"
