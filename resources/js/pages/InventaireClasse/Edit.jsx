...
const Edit = ({ inventaire, classes, materiels }) => {
    const { data, setData, put, processing, errors } = useForm({
        classe_id: inventaire.classe_id,
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/inventaires-classes/${inventaire.id}`);
    };
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-indigo-100 mt-2 text-lg">
                                {inventaire.materiel.nom} - {inventaire.classe.nom}
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            ...
                            <div>
                                ...
                                <span className="ml-2 text-gray-900">
                                    {new Date(inventaire.date_ajout).toLocaleDateString('fr-FR')}
                                </span>
                            </div>
                            <div>
                                <span className="font-medium text-gray-700">Dernière modification :</span>
                                <span className="ml-2 text-gray-900">
                                    {new Date(inventaire.updated_at).toLocaleDateString('fr-FR')}
                                </span>
                            </div>
                            <div>
                    ...
                    <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-4 pt-8 border-t border-gray-200">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-3 px-8 py-3.5 bg-gradient-to-r from-indigo-600 to-purple-700 text-white rounded-xl hover:from-indigo-700 hover:to-purple-800 focus:ring-4 focus:ring-indigo-500/20 disabled:opacity-50 transition-all duration-200 transform hover:scale-105 shadow-lg"
                            >
                                {processing ? (
                                    <>
