...
const Edit = ({ bus }) => {
    const { data, setData, put, processing, errors } = useForm({
        ...
        chauffeur_nom: bus.chauffeur_nom || '',
        chauffeur_telephone: bus.chauffeur_telephone || '',
        etat: bus.etat || 'actif'
    });
    ...
    return (
        <AppLayout>
            <Head title={`Modifier le Bus - ${bus.immatriculation}`} />
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3.5 rounded-xl border-2 ${
                                        errors.immatriculation ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-amber-500'
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3.5 rounded-xl border-2 ${
                                        errors.capacite ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-amber-500'
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3.5 rounded-xl border-2 ${
                                        errors.chauffeur_nom ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-amber-500'
                                    } focus:ring-4 focus:ring-amber-500/20 transition-all duration-200 bg-white`}
                    ...
                    <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border border-blue-200">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <span className="font-medium text-blue-700">ID du bus :</span>
                                <span className="ml-2 text-blue-900 font-mono">{bus.uid}</span>
                            </div>
                            <div>
                            ...
                            <div>
                                <span className="font-medium text-blue-700">État actuel :</span>
                                <span className={`ml-2 font-medium ${
                                    bus.etat === 'actif' ? 'text-green-600' : 
                                    bus.etat === 'maintenance' ? 'text-orange-600' : 'text-red-600'
                                }`}>
                                    {bus.etat === 'actif' ? 'Actif' : 
                                     bus.etat === 'maintenance' ? 'En Maintenance' : 'Hors Service'}
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="flex flex-col-reverse md:flex-row justify-between items-center gap-4 pt-8 border-t border-gray-200">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 w-full md:w-auto">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="flex items-center justify-center gap-3 px-8 py-3.5 bg-gradient-to-r from-amber-600 to-orange-700 text-white rounded-xl hover:from-amber-700 hover:to-orange-800 focus:ring-4 focus:ring-amber-500/20 disabled:opacity-50 transition-all duration-200 transform hover:scale-105 shadow-lg"
                            >
                                {processing ? (
                                    <>
