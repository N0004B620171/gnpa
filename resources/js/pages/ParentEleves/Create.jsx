...
const Create = () => {
    ...
    const handleSubmit = (e) => {
        ...
        // Si creer_compte est false, on ne envoie pas le password
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-blue-100 mt-2 text-lg">
                                Ajoutez un nouveau parent ou tuteur légal dans le système
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3.5 rounded-xl border-2 ${errors.prenom ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3.5 rounded-xl border-2 ${errors.email ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'
                                        } focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 bg-white`}
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3.5 rounded-xl border-2 ${errors.telephone ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'
                                        } focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 bg-white`}
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                rows={3}
                                className={`w-full px-4 py-3.5 rounded-xl border-2 ${errors.adresse ? 'border-red-500 focus:border-red-500' : 'border-gray-200 focus:border-blue-500'
                    ...
                    <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <label htmlFor="creer_compte" className="ml-3 block text-sm font-medium text-gray-900">
                                Créer un compte utilisateur pour ce parent
                            </label>
                        </div>
                        ...
                        {data.creer_compte && (
                            <div className="mt-4 p-4 bg-white rounded-xl border border-blue-200">
                                ...
                                <input
                                    ...
                                    className={`w-full px-4 py-3.5 rounded-xl border-2 ${errors.password ? 'border-red-500 focus:border-red-500' : 'border-blue-200 focus:border-blue-500'
                                        } focus:ring-4 focus:ring-blue-500/20 transition-all duration-200 bg-white`}
                                ...
                                <p className="mt-2 text-sm text-gray-600">
                                    Le parent pourra se connecter avec son email et ce mot de passe
                                </p>
                            </div>
                        )}
                    </div>
                        ...
                        >
                            {processing ? (
                                ...
                                <>
                                    ...
                                    <span className="font-semibold">Créer le parent</span>
                                </>
                            )}
                        </button>
                    </div>
