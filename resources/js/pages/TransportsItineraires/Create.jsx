                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-violet-100 mt-2 text-lg">
                                Créer une nouvelle ligne de transport scolaire
                            </p>
                        </div>
                ...
                <form onSubmit={handleSubmit} className="p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-2">
                                Donnez un nom descriptif pour identifier facilement cet itinéraire
                            </p>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-2">
                                Vous pouvez assigner un bus ultérieurement
                            </p>
                        </div>
                                ...
                                <div className="flex items-center">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-sm text-blue-700">
                                            Prêt à être assigné à cet itinéraire
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div>
                        ...
                        <div>
                            ...
                            <p className="text-sm text-gray-500 mt-2">
                                Associez un service de transport pour la facturation
                            </p>
                        </div>
                    ...
                    {/* Aperçu */}
                    {(data.nom || data.bus_id || data.service_id) && (
                        <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-2xl p-6 border border-violet-200">
                            <h4 className="text-sm font-semibold text-violet-800 mb-4 flex items-center">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                                <div>
                                    <span className="font-medium text-violet-700">Nom :</span>
                                    <span className="ml-2 text-violet-900">
                                        {data.nom || <span className="text-orange-500">Non renseigné</span>}
                                    </span>
                                </div>
                                <div>
                                    <span className="font-medium text-violet-700">Bus :</span>
                                    <span className="ml-2 text-violet-900">
                                        {selectedBus ? selectedBus.immatriculation : <span className="text-orange-500">Non assigné</span>}
                                    </span>
                                </div>
                                <div className="md:col-span-2">
                                    <span className="font-medium text-violet-700">Service :</span>
                                    <span className="ml-2 text-violet-900">
                                        {selectedService ? (
                                            <span>
                                                {selectedService.nom} ({formatMontant(selectedService.montant)})
                                            </span>
                                        ) : (
                                            <span className="text-orange-500">Aucun service</span>
                                        )}
                                    </span>
                                </div>
                            </div>
                        ...
                        >
                            {processing ? (
                                ...
                                <>
                                    ...
                                    <span className="font-semibold">Créer l'itinéraire</span>
                                </>
                            )}
                        </button>
                    </div>
